...
export type MasterMaterialOption = {
  id: string;
  name: string;
  color: string;
  description?: string;
...
export const masterBrands: MasterBrand[] = [
  {
    id: "leicht",
    name: "LEICHT",
...
export const masterStyles: MasterStyle[] = [
  {
    id: "modern",
    name: "Modern",
    description:
      "Strakke lijnen, geintegreerde apparatuur en een monochroom palet bepalen deze architectonische benadering van keukendesign.",
  ...
  },
  {
    ...
    name: "Klassiek",
    description:
      "Tijdloze elegantie door klassieke verhoudingen, verfijnde details en materialen die met de jaren alleen maar mooier worden.",
  ...
  },
  {
    ...
    name: "Landelijk",
    description:
      "De warmte van natuurlijke materialen en ambachtelijke details uit het buitenleven, vertaald naar een verfijnde eigentijdse keuken.",
  ...
  },
  {
    ...
    name: "Industrieel",
    description:
      "Ruwe stedelijke materialen krijgen een hoogwaardig designkarakter. Staal, beton en zichtbare structuren zorgen voor een krachtige uitstraling.",
...
export const masterBudgetRanges: Record<string, string> = {
...
export const masterConsultationBudgets = [
  "€20,000 tot €40,000",
  "€40,000 tot €70,000",
  "€70,000 tot €120,000",
  "€120,000 tot €200,000",
