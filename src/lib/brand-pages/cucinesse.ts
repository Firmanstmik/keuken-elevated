...
export const cucinessePage = {
  ...
  meta: {
    ...
    description:
      "Ontdek Cucinesse bij Keuken-Centrum Utrecht. Modulaire Italiaanse keukens sinds 1979 — oneindig veel oplossingen, bijpassende livingmeubels en meer dan 25 jaar ervaring bij Keuken-Centrum.",
  },
  hero: {
  ...
  intro: {
    ...
    paragraphs: [
      ...
      "Ruim veertig jaar later is Cucinesse getransformeerd tot een hoofdrolspeler in de productie van modulaire keukens met klanten over de hele wereld. Cucinesse biedt oneindig veel oplossingen om uw keuken uniek te maken — handgrepen op kasten en lades, werkbladen en fronts in vele vormen en afwerkingen.",
  ...
  pillars: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Bijpassende maatwerk meubels voor de living — audio meubels, salontafels en wandmeubels op maat, helemaal in stijl met de keuken voor tijdloze eenheid.",
        icon: "layers",
        image: `${wp}/cucinesse-cucina-lab-4-5.webp`,
      },
      {
        ...
        description:
          "Creativiteit om het ideale ontwerp te maken en vakmanschap zodat een prachtig plan wordt omgezet in resultaat — van A tot Z op uw wenken bediend, binnen budget en volgens planning.",
        icon: "award",
