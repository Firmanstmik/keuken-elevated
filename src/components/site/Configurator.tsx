          ...
          >
            <div className="max-w-[38rem]">
              ...
              <motion.h2 variants={reduceMotion ? undefined : fadeUp} className="heading-2">
                Configureer uw
                <br />
                <em className="italic" style={{ color: "#8BC540" }}>droomkeuken.</em>
              </motion.h2>
            </div>
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="hidden min-w-[220px] lg:block">
                    <div className="h-1.5 w-full bg-[rgba(17,17,17,0.08)]">
                      <div
                        className="h-full bg-[#8BC540] transition-[width] duration-500 ease-[var(--ease-premium)]"
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          active
                            ? "border-[#8BC540] bg-[rgba(139,197,64,0.07)]"
                            : "border-[var(--border)] bg-white/50",
                          clickable ? "cursor-pointer hover:border-[#8BC540]" : "cursor-not-allowed opacity-55",
                        )}
                      >
                        <span
                          className={cn(
                              ...
                              return (
                                <button
                                  ...
                                  className={cn(
                                    ...
                                    active
                                      ? "border-[rgba(139,197,64,0.45)] bg-[rgba(139,197,64,0.12)] text-white"
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                ...
                                active
                                  ? "border-[var(--accent)] bg-[rgba(139,197,64,0.07)]"
                    ...
                    <div className="surface-card p-5 md:p-6">
                      {!consultationSent ? (
                        ...
                        <div className="flex min-h-[420px] flex-col items-start justify-center">
                          <span className="inline-flex h-16 w-16 items-center justify-center border border-[var(--accent)] bg-[rgba(139,197,64,0.07)] text-[var(--accent)]">
