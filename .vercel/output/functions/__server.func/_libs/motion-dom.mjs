...
export {
  ...
  isElementTextInput as B,
  isForcedMotionValue as C,
  isHTMLElement as D,
  isMotionValue as E,
  Feature as F,
  isPrimaryPointer as G,
  ...
  resolveMotionValue as X,
  resolveVariant as Y,
  resolveVariantFromProps as Z,
  scrapeMotionValuesFromProps$1 as _,
  HTMLVisualElement as a,
  setDragLock as a0,
  setFeatureDefinitions as a1,
  supportsScrollTimeline as a2,
  supportsViewTimeline as a3,
  transform as a4,
  addDomEvent as b,
  ...
  hasReducedMotionListener as v,
  hover as w,
  initPrefersReducedMotion as x,
  interpolate as y,
  isAnimationControls as z
};
