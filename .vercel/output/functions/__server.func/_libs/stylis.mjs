...
function requireStylis() {
  ...
  (function(module, exports) {
    (function(e, r) {
      ...
      function J(r2, a2) {
        while (F()) if (r2 + e.character === 47 + 10) break;
        else if (r2 + e.character === 42 + 42 && I() === 47) break;
      ...
      function ee(e2, r2, a2, c2, n2, t2, s2, i2, u2) {
        ...
        while (b2) switch (v2 = m2, m2 = F()) {
          ...
          case 0:
            switch (m2) {
              ...
              default:
                ...
                if (m2 === 123) if (f2 === 0) ee(y2, r2, E2, E2, k2, t2, l2, i2, x2);
                else switch (p2 === 99 && M(y2, 3) === 110 ? 100 : p2) {
                  case 100:
                  case 108:
                  case 109:
                  case 115:
          ...
          default:
            if (d2 < 1) {
              if (m2 == 123) --d2;
              else if (m2 == 125 && d2++ == 0 && _() == 125) continue;
            }
            switch (y2 += $(m2), m2 * d2) {
              case 38:
                w2 = f2 > 0 ? 1 : (y2 += "\f", -1);
