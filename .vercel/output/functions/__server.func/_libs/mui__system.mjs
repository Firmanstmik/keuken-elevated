...
import { a as internal_serializeStyles, i as internal_mutateStyles, s as styled } from "./mui__styled-engine.mjs";
import { i as isObjectEmpty, f as fastDeepAssign, c as capitalize, d as deepmerge, j as isPlainObject, e as formatMuiErrorMessage, a as clamp, r as resolveProps } from "./mui__utils.mjs";
    ...
    function process(sxInput) {
      ...
      for (const styleKey in sxObject) {
        ...
        if (hasBreakpoint(breakpoints, value)) {
          ...
          wrapper.sx = value;
          css[styleKey] = styleFunctionSx2(wrapper);
        }
      }
...
function createStyled(input = {}) {
  ...
  const styled$1 = (tag, inputOptions = {}) => {
...
export {
  ...
  createGetColorSchemeSelector as c,
  createSpacing as d,
  createStyled as e,
  createTheme as f,
  createUnarySpacing as g,
  darken as h,
  defaultSxConfig as i,
  getContrastRatio as j,
  hslToRgb as k,
  lighten as l,
  prepareTypographyVars as m,
  private_safeAlpha as n,
  private_safeColorChannel as o,
  prepareCssVars as p,
  private_safeDarken as q,
  private_safeEmphasize as r,
  private_safeLighten as s,
  styleFunctionSx as t,
  unstable_memoTheme as u,
