...
import { A as ArrowLeft, l as logoKeuken, d as Circle, S as Search, a as ArrowRight } from "./logo-keuken-1-1-Bm1V1T7d.mjs";
import { u as useConfigurator } from "./router-CEr30ci8.mjs";
import { a as masterBudgetRanges, b as masterCategories, m as masterBrands, f as masterStyles, d as masterHotspotPositions } from "./master-config-data-BckWo8u5.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: imageViewportRef, className: "relative min-h-[280px] flex-none overflow-hidden bg-[#0A0A0A] md:h-[calc(100vh-62px)] md:basis-[68%]", onWheel: (event) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { animate: {
          ...
          masterHotspotPositions.map((hotspot) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", title: hotspot.label, "data-hotspot": "true", onClick: () => setActiveCategory(active ? null : hotspot.id), className: "absolute -translate-x-1/2 -translate-y-1/2 cursor-pointer", style: {
              left: hotspot.x,
              top: hotspot.y
            }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.span, { whileHover: {
                ...
                duration: 2
              }, className: "flex h-8 w-8 items-center justify-center rounded-full border-2 backdrop-blur-[8px] transition-all duration-300", style: {
                backgroundColor: active ? "#B08D57" : selected ? "rgba(176,141,87,0.85)" : "rgba(247,245,242,0.2)",
                borderColor: active || selected ? "#B08D57" : "rgba(247,245,242,0.6)",
                boxShadow: active ? "0 0 20px rgba(176,141,87,0.5)" : "none"
              }, children: selected ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2.5 w-2.5 rounded-full border border-[rgba(255,255,255,0.6)]", style: {
                backgroundColor: selected.color
              } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Circle, { className: "h-2 w-2 text-[rgba(247,245,242,0.8)]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-1/2 top-full mt-0.5 -translate-x-1/2 whitespace-nowrap rounded-[10px] bg-[rgba(17,17,17,0.85)] px-1.5 py-1 text-[0.6rem] uppercase tracking-[0.12em] text-[#F7F5F2] backdrop-blur-[8px] transition-opacity duration-200", style: {
                opacity: active ? 1 : 0
              }, children: selected ? selected.name : hotspot.label })
            ] }, hotspot.id);
          })
        ] }),
