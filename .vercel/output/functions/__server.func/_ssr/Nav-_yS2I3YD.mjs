...
import { l as logoKeuken, b as ChevronDown } from "./logo-keuken-1-1-Bm1V1T7d.mjs";
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: hasDropdown && isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                            motion.div,
                            {
                              ...
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2", children: item.items?.map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                "span",
                                {
                                  ...
                                  "aria-disabled": true,
                                  children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: sub.label }),
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-px w-10 bg-[linear-gradient(90deg,rgba(201,164,106,0),rgba(201,164,106,0.75),rgba(201,164,106,0))] opacity-0 transition-opacity duration-300 group-hover:opacity-100" })
                                  ]
                                },
                                sub.label
                              )) })
