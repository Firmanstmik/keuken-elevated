...
import { N as Nav, a as motionEase, m as motionDuration, s as staggerHeader$3, b as motionViewport, f as fadeUp$6, c as staggerList } from "./Nav-_yS2I3YD.mjs";
...
import { k as kc } from "./router-CEr30ci8.mjs";
...
const heroImage = "/assets/Keukens_voor_elke_prijs-CT5jnOru.webp";
const accentImage = "/assets/Modern_keukens-CfEDTX6p.webp";
const stats = [
...
function ShowroomJourneySection() {
  const reduceMotion = useReducedMotion();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 md:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "site-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.92fr)] lg:items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: reduceMotion ? false : "hidden",
