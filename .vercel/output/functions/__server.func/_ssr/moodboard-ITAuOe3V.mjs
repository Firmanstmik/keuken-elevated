...
import { F as FlowNav } from "./FlowNav-CSeLdN-h.mjs";
import { a as ArrowRight } from "./logo-keuken-1-1-Bm1V1T7d.mjs";
import { u as useConfigurator } from "./router-CEr30ci8.mjs";
import { b as masterCategories, a as masterBudgetRanges, m as masterBrands, f as masterStyles } from "./master-config-data-BckWo8u5.mjs";
...
const companyLogo = "/assets/Logo_Keuken_Centrum-CM2s7upW.png";
function MoodboardPage() {
  ...
  reactExports.useMemo(() => masterStyles.find((style) => style.id === config.style) ?? null, [config.style]);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.section, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[60vh] overflow-hidden md:h-[80vh]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-cover bg-center", style: {
          backgroundImage: "url(/moodboard-render.webp)"
        } }),
