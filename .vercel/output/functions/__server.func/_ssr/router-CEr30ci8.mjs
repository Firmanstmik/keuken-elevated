...
const appCss = "/assets/styles-u2wq84YR.css";
...
const $$splitComponentImporter$5 = () => import("./style-BZJn1IzX.mjs");
const Route$5 = createFileRoute("/style")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./moodboard-ITAuOe3V.mjs");
const Route$4 = createFileRoute("/moodboard")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./consultation-B8zBC5OJ.mjs");
const Route$3 = createFileRoute("/consultation")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./configure-DFFG1CQb.mjs");
const Route$2 = createFileRoute("/configure")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./brands-oDj3EslC.mjs");
...
const $$splitComponentImporter = () => import("./index-Do4ohSaK.mjs");
