...
const showroomImg = "/assets/showroom-BIgnA1P8.jpg";
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `grid gap-1.5 ${item.label === "Keukens" || item.label === "Apparatuur" ? "grid-cols-2" : "grid-cols-1"}`, children: item.items?.map((sub, index) => {
                                    ...
                                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                      motion.div,
                                      {
                                        ...
                                        children: [
                                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-9 w-9 shrink-0 place-items-center rounded-lg border border-[#E5DCD3]/30 bg-white shadow-[0_4px_12px_-4px_rgba(23,25,28,0.06)] group-hover:bg-[#FAF8F4] transition-colors duration-300", children: IconComponent && /* @__PURE__ */ jsxRuntimeExports.jsx(IconComponent, { className: "h-4 w-4 text-[#23B9C4] group-hover:text-[#163847] transition-colors duration-300" }) }),
                                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "min-w-0 flex-1", children: [
                                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] font-semibold tracking-[0.02em] text-[#111111] transition-colors duration-300 group-hover:text-[#23B9C4]", children: sub.label }) }),
          ...
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[90] bg-[rgba(247,245,242,0.96)] backdrop-blur-[6px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "nav-mobile-panel flex min-h-[100dvh] flex-col", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-7", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "flex items-center", onClick: () => setOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoKeuken, alt: "Keuken Centrum logo", className: "h-10 w-auto", width: 343, height: 56 }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                        ...
                        motion.div,
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            AccordionItem,
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "py-3.5 text-[15px] font-medium tracking-[0.06em] text-[#111111] hover:no-underline hover:text-[#23B9C4] [&[data-state=open]]:text-[#23B9C4] [&[data-state=open]>svg]:rotate-180", children: item.label }),
