...
const appCss = "/assets/styles-DiY6f74P.css";
...
const shareLogo = "/assets/Logo_Keuken_Centrum-CM2s7upW.png";
...
const $$splitComponentImporter$5 = () => import("./style-D-cH8wJ9.mjs");
const Route$5 = createFileRoute("/style")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./moodboard-CdDMVPtd.mjs");
const Route$4 = createFileRoute("/moodboard")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./consultation-Bm1u3hj1.mjs");
const Route$3 = createFileRoute("/consultation")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./configure-BVI098HV.mjs");
const Route$2 = createFileRoute("/configure")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./brands-D2Q2x_kX.mjs");
...
const $$splitComponentImporter = () => import("./index-D_26Qie4.mjs");
