...
const front$3 = { "x": "50%", "y": "78%" };
const werkblad$3 = { "x": "58%", "y": "61%" };
const spoelbak$3 = { "x": "31%", "y": "59%" };
const apparatuur$3 = { "x": "20%", "y": "48%" };
const quooker$3 = { "x": "33%", "y": "50%" };
const bora$3 = { "x": "49%", "y": "54%" };
const grepen$3 = { "x": "83%", "y": "46%" };
const verlichting$3 = { "x": "50%", "y": "7%" };
const modernHotspots = {
  front: front$3,
  werkblad: werkblad$3,
  spoelbak: spoelbak$3,
  apparatuur: apparatuur$3,
  quooker: quooker$3,
  bora: bora$3,
  grepen: grepen$3,
  verlichting: verlichting$3
};
const front$2 = { "x": "63%", "y": "75%" };
const werkblad$2 = { "x": "38%", "y": "60%" };
const spoelbak$2 = { "x": "53%", "y": "59%" };
const apparatuur$2 = { "x": "88%", "y": "51%" };
const quooker$2 = { "x": "52%", "y": "50%" };
const bora$2 = { "x": "46%", "y": "54%" };
const grepen$2 = { "x": "11%", "y": "60%" };
const verlichting$2 = { "x": "49%", "y": "22%" };
const klassiekHotspots = {
  front: front$2,
  werkblad: werkblad$2,
  spoelbak: spoelbak$2,
