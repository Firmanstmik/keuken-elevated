...
function kc_icon_brand(string $name): string {
	$map = [
		...
		'home' => '<path d="M12 18v-3M10.07 2.82 3.14 8.37C2.36 8.99 1.86 10.3 2.03 11.28l1.33 7.96c.24 1.44 1.6 2.62 3.06 2.62h11.14c1.45 0 2.82-1.19 3.06-2.62l1.33-7.96c.16-.98-.34-2.29-1.11-2.91l-6.93-5.54c-1.07-.86-2.8-.86-3.84-.01Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',
