...
function kc_configurator_catalog(): array {
	...
	return [
		...
		'customerReviews' => [
			...
			'count' => '125',
			'default' => [
				'quote'    => 'Prima ontwerp keuken. Zeer actief meegedacht en alle relevante opties gepresenteerd. De keukeninstallatie is conform alle wensen geschied.',
				'author'   => 'Pierre H.',
				'location' => 'Utrecht',
			],
			'byBrand' => [
				'leicht' => [
					'quote'    => 'We wilden geen standaard keuken, maar een ruimte die rust, precisie en luxe uitstraalt. Het ontwerp voelde vanaf de eerste presentatie architectonisch doordacht.',
				...
				'ai-kuchen' => [
					'quote'    => 'Eindelijk een keukencentrum die je eerlijk behandelt, zowel qua prijs en kwaliteit. Zeer goed geholpen en we hebben een prachtige keuken gekregen.',
					'author'   => 'Arjan Malek',
					'location' => 'Utrecht',
				],
				'zampieri' => [
