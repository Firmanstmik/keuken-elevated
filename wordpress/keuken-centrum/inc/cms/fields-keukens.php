...
function kc_cms_register_keukens_field_groups(): void {
		...
		[
			...
			'fields' => [
				[
					...
					'label'   => 'Instructie',
					'type'    => 'message',
					'message' => 'Laat velden leeg om de standaard site-inhoud te behouden. Merkpagina’s bewerkt u via Keukens → individueel merk.',
				],
				...
				[ 'key' => 'field_kc_kov_bottom_title', 'label' => 'Titel (voor accent)', 'name' => 'keukens_ov_bottom_title', 'type' => 'text', 'instructions' => 'Bijv. Klaar voor uw' ],
				[ 'key' => 'field_kc_kov_bottom_title_em', 'label' => 'Titel accent', 'name' => 'keukens_ov_bottom_title_em', 'type' => 'text', 'instructions' => 'Bijv. droomkeuken' ],
		...
		[
			...
			'fields' => [
				[
					...
					'label'   => 'Instructie',
					'type'    => 'message',
					'message' => 'Laat velden leeg om de standaard site-inhoud te behouden. Logo en hero-afbeelding onder “Merk Details” worden ook gebruikt.',
				],
	...
	$series_fields = [
		[
			...
			'label'   => 'Instructie',
			'type'    => 'message',
			'message' => 'Laat velden leeg om de standaard site-inhoud te behouden. Gerelateerde series worden automatisch afgeleid.',
		],
	];
